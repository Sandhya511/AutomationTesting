...
public class Task2 {
	public static void main(String [] args)
	{
		...
		driver.findElement(By.xpath("//*[@id=\"first_name\"]")).sendKeys("Sandhya");
		driver.findElement(By.xpath("//*[@id=\"last_name\"]")).sendKeys("A");
		driver.findElement(By.xpath("//*[@id=\"user_email\"]")).sendKeys("sak@gmail.com");
		driver.findElement(By.xpath("//*[@id=\"radio_1665627729_Female\"]")).click();
		driver.findElement(By.xpath("//*[@id=\"user_pass\"]")).sendKeys("123456");
		driver.findElement(By.xpath("//*[@id=\"date_box_1665628538_field\"]/span/input[1]")).sendKeys("5/11/2003");
		...
		driver.findElement(By.xpath("//*[@id=\"phone_1665627865\"]")).sendKeys("648156465");
